  ...
  <section class="products">
    <div class="container">
      ...
      <div class="products-wrapper" id="rests-container">
        <router-link class="products-card" v-for="rest in store.rests" :key="rest.id" :to="`/rest?id=${rest.id}`">
          <div class="products-card__image">
            <img :src="getUrl(rest.image)" :alt="`${rest.title}`" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h4 class="products-card__decription--title">{{ rest.title }}</h4>
              <div class="products-card__decription--badge">
                {{ rest.time }} мин
              </div>
            </div>
            <div class="products-card__description-row">
              <div class="products-card__description-info">
                ...
                <div class="products-card__description-info--groupe">
                  {{ rest.type }}
                </div>
              </div>
            </div>
